...
![](https://github.com/Patcharanan/LAB-06/blob/master/imgs/3.PNG?raw=true)

###คำถาม 6.3 ถ้าเราป้อนตัวอักษรลงไปแทนที่ตัวเลข จะเกิดอะไรขึ้น มีวิธีการป้องกันหรือแก้ไขอย่างไร
```
โปรแกรมจะเกิด Error แล้วบังคับปิดโปรแกรม อาจจะแก้ด้วยการเขียนบอกว่าให้ป้อนข้อมูลเฉพาะตัวเลขลงไปเท่านั้น
```
...
```
โปรแกรมจะขึ้น Error เหมือนเดิมแต่จะไม่ StopWorking แล้ว 
```
